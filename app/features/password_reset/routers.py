...
async def forgot_page(request: Request):
    return templates.TemplateResponse("forgot_password.html", {"request": request, "show_nav": False})


@router.post("/forgot-password")
async def forgot_submit(background_tasks: BackgroundTasks, request: Request, email: str = Form(...),
